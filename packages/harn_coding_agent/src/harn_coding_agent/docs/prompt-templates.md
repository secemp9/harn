> harn can create prompt templates. Ask it to build one for your workflow.
...
Harn loads prompt templates from:

- Global: `~/.harn/agent/prompts/*.md`
- Project: `.harn/prompts/*.md`
- Packages: `prompts/` directories or `harn.prompts` entries in `pyproject.toml`
